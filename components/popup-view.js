(function(){
  ...
  polymer_ext({
    ...
    survey_button_clicked: async function(){
      ...
      userid = (await get_user_id());
      chrome.tabs.create({
        url: survey_data.url + '?habitlab_userid=' + userid + '&click_location=dropdown'
      });
    ...
    ready: async function(){
      ...
      survey_data = localstorage_getjson("survey_data");
      if (deepEq$(typeof survey_data, 'undefined', '===')) {
        localstorage_setjson("survey_data", {});
